...
export const getEmployeeList = async (infState) => {
    setHeader(localStorage.accessToken)
    const response = await axios.post(infState.api+'getEmpList')
    console.log("response service: ", response)
    return response.data;
}

export const empRegister = async (infState, payload) => {
    setHeader(localStorage.accessToken)
    const response = await axios.post(infState.api+'registerEmp', {mode:'cors'}, payload)
    console.log("response service: ", response)
    return response.data;
}
