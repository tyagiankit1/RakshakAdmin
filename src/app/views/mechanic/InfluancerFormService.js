...
export const getAllMechanicDetails = async (infState) => {
    setHeader(localStorage.accessToken)
    const response = await axios.post(infState.api+'getAllMechanicDetails', {mode:'cors'})
    console.log("response service: ", response)
    return response.data;
}

export const cleanMechanicData = async (infState) => {
    setHeader(localStorage.accessToken)
    const response = await axios.post(infState.api+'cleanMechanicData', {mode:'cors'})
    console.log("response service: ", response)
    return response.data;
}
