...
import { saveInfData, updateInfData } from './AirlineFormService'
...
export default function StepperForm() {
    ...
    const createRequestPayload = (status, type,  editorData, faqData) => {
        return {  
    ...
    function savePersonalDetails(personalData) {
        if(personalData && state.personalDataStatus ){
            ...
            saveInfData(infState, createRequestPayload("Draft", "create" , editorData, faqData)).then(( data ) => {
    ...
    function saveEditorDetails(editorData) {
        if(editorData && state.editorDataStatus){
            ...
            setProfessionalData(professionalData);
              let payload = {airport_id: airId, update_data: createRequestPayload("Draft", "update", professionalData, editorData, faqData)}
